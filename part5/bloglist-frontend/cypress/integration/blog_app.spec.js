describe('Blog app', function() {
  ...
  describe('when logged in', function() {
    ...
    it('an existing blog can be liked', function() {
      cy.createBlog({ title: 'Existing Blog Title', author: 'Some Author', url: 'www.google.com' })
    ...
    it('the listed blogs are ordered according to likes with the most liked first', function() {
      cy.createBlog({ title: 'Title #1', author: 'Author A', url: 'www.google.com', likes: 1 })
      cy.createBlog({ title: 'Title #2', author: 'Author B', url: 'www.google.com', likes: 2 })
      cy.createBlog({ title: 'Title #3', author: 'Author C', url: 'www.google.com', likes: 3 })
